...
func main() {
	serversPtr := flag.String("servers", "servers.json", "List of rpc cluster servers.")
	...
	pool := rpc.NewPool(conns, newConnection, servers...)
...
func handleConnection(clientConn net.Conn, pool *rpc.Pool, circle *rpc.Circle) {
...
func readServers(filepath *string) []*rpc.Server {
...
func monitorServers(serversFile *string, circle *rpc.Circle) {
